...
public class TargetInformation : IEquatable<TargetInformation>
{
    ...
    public float Age => (float)(Time.timeAsDouble - LastSeen);
    ...
    public static bool operator ==(TargetInformation a, TargetInformation b) => a?.Id == b?.Id;
    public static bool operator !=(TargetInformation a, TargetInformation b) => a?.Id != b?.Id;
}
